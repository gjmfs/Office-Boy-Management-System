...
if(isset($_POST['submit'])){
    ...
    $check=$connection->query("select * from employee where table_no='$table_no'");
    if($check->num_rows>0){
        $sql="insert into request(employee_name,table_no,subject,msg,drink_item,quantity) values('$e_name','$table_no','$subject','$msg','$drink','$quantity')";
